...
export const options = {
  stages: [
    ...
    { duration: "2m", target: 50 }, // aumenta a carga
    { duration: "2m", target: 150 }, // carga alta -> HPA deve escalar aqui
    { duration: "3m", target: 200 }, // pico máximo
    { duration: "2m", target: 50 }, // queda (HPA começa a reduzir)
